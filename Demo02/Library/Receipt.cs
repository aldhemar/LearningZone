...
namespace Library
{
    public class Receipt : Model.IReceipt<Receipt, ReceiptLine, ReceiptTender>
    {
        ...
        public List<ReceiptTender> ReceiptTender { get; set; }

        public dynamic GetByDate(string sDate)
        {
         throw new NotImplementedException();
      }

        public dynamic GetByDocNumber(string sDocNumeber)
        {
         throw new NotImplementedException();
      }
      ...
      public dynamic GetData(string criteria = "1=1")
      {
         string conexion = "uid=RetailUser;password=retail;database=RetailData;server=127.0.0.1;Connect Timeout=180;pooling=false";
         DataSet dataSet = DataAccess.GetDataSetQry(conexion, "SELECT * FROM RECEIPT WHERE " + criteria);
